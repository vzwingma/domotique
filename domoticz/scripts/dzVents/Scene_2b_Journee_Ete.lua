...
return
{
    ...
    execute = function(domoticz, scene)
        ...
        function ouvertureVoletMatinEte(modeDomicile, presenceDomicile, domoticz)
            -- Ouverture du groupe Salon & Chambre Nous uniquement, les volets bébé s'ouvrent au min du mode et de l'ouverture courante
            local levelNous = domoticz.variables(domoticz.helpers.VAR_PRCENT_VOLET_MATIN .. modeDomicile .. presenceDomicile).value
            ...
            local paramOuvertureJourEte = domoticz.variables(domoticz.helpers.VAR_PRCENT_VOLET_MATIN .. modeDomicile .. presenceDomicile).value
        ...
        if(presenceDomicile == '') then
            ...
            ouvertureVoletMatinEte(modeDomicile, presenceDomicile, domoticz)
        -- Absence
