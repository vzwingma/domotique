...
|---|---|---|---|
| `httpd-proxy` | `vzwingmadomatic/httpd` (Apache 2.4) | 80, 8243, 8280 | Proxy frontal TLS (Let's Encrypt), point d'entree externe |
...
| `certbot` | `certbot/certbot` | — | Renouvellement auto certificat Let's Encrypt (12h) |
